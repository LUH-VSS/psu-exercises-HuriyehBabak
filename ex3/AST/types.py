...
from utils.typeguard import check_type
...
@dataclass
class Expr(Stmt):
    type: TypeExpr = Node.attribute()  # type: ignore
...
class Identifier(Expr):
    name: str = Node.attribute(init=True)  # type: ignore


@dataclass
class Literal(Expr):
    value: int = Node.attribute(init=True)  # type: ignore
