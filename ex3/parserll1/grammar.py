...
class Terminal:
    def __init__(self, name: str, regex: Optional[str] = None, skip=False, eof=False):
        self.name = name
        self.regex = regex
        self.skip = skip
        self.eof = eof
...
Symbol = Union[Terminal, NonTerminal, Epsilon]
...
class Rule:
    def __init__(self, lhs: NonTerminal, rhs: Word, action: Optional[str] = None):
...
class Grammar:
    ...
    rules: list[Rule]
    start_symbol: Optional[NonTerminal]
    ...
    def T(self, name: str, regex: Optional[str] = None, skip=False):
    ...
    def NT(self, name: str, start=False):
    ...
    def addRule(self, lhs: NonTerminal, rhs: Word, action=None):
    ...
    def addImport(self, name: str, module):
