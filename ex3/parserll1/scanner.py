...
class Token:
    def __init__(self, type: str, load: str, line: int, col: int):
        self.type = type
        self.load = load
        self.line = line
        self.col = col
...
class BaseScanner:
    scanner_table: list[tuple[str, str, bool]] = []
